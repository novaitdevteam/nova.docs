#Nova.BotFlow Smooch (WhatsApp integration)
##Features
####Text
...
<figure> <img src="/novadocs/components/botflow/examples/SmoochFlowQuickReplies.png" title="WhatsApp Quick Replies" width="600" height"500"> </a> </figure>
####Card
